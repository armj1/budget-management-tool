          ...
          {canCompare && (
            <div>
              ...
              <p className="flex flex-row">
                <TrendingUp className="mr-2" /> norāda uz pieaugumu noteiktā
                budžeta kategorijā
              </p>
              <p className="flex flex-row">
                <TrendingDown className="mr-2" /> norāda uz samazinājumu
                noteiktā budžeta kategorijā
              </p>
              <div className="flex flex-row pt-2">
                <Card className="flex flex-row p-2 mb-2 mr-3 w-80">
                  Pārtika: €-56.44 <TrendingDown className="ml-3" />
                </Card>
                apzīmē, ka izdevumi par pārtiku atskaitē №2 ir mazāki par €56.44
                nekā atskaitē №1
              </div>
            </div>
          )}
